...
public class Cell_IO {
	...
	public String stats(HashMap<Integer, Cell> cells) {
		...
		String s = "\nMedia de capacidades actuales de las celdas: " + numberFormat.format(mediaCapacidades)
				+ " presos por celda" + "\r\nMedia de niveles de seguridad de las celdas: "
				+ numberFormat.format(mediaSeguridad) + " sobre 5" + "\r\nPorcentaje de celdas llenas: "
				+ numberFormat.format(porcentajeLlenas) + "%" + "\r\nPorcentaje de celdas abiertas: "
				+ numberFormat.format(porcentajeAbiertas) + "%";
		return s;
	}
}