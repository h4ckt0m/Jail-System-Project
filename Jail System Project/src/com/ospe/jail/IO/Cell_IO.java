...
public class Cell_IO {
	...
	public void realizarConsulta(HashMap<Integer, Cell> Cells, String mainPath) {
	...
	public void exportCSV(HashMap<Integer, Cell> query, String mainPath) {
	...
	public String stats(HashMap<Integer, Cell> cells) {
		...
		String s = "\nCells current capacity average: " + numberFormat.format(mediaCapacidades) + " prisoners by cell"
				+ "\r\nCells security level average: " + numberFormat.format(mediaSeguridad) + " over 3"
				+ "\r\nPercentage of full cells: " + numberFormat.format(porcentajeLlenas) + "%"
				+ "\r\nPercentage of open cells: " + numberFormat.format(porcentajeAbiertas) + "%";
		return s;
	}
}