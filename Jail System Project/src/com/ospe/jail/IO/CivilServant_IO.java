...
public class CivilServant_IO {
	...
	public void realizarConsulta(HashMap<String, CivilServant> CivilServants, String mainPath) {
	...
	public void exportCSV(HashMap<String, CivilServant> query, String mainPath) {
		read.nextLine();
	...
	public String stats(HashMap<String, CivilServant> CivilServants) {
		...
		String s = "\nCivil servants height average: " + numberFormat.format(mediaAlturas) + " cm"
				+ "\r\nCivil servants age average: " + numberFormat.format(mediaEdades) + " years"
				+ "\r\nPercentage of civil servants with morning shift: " + numberFormat.format(porcentajeMorning) + "%"
				+ "\r\nPercentage of civil servants with evening shift: " + numberFormat.format(porcentajeTarde) + "%"
				+ "\r\nPercentage of civil servants with night shift: " + numberFormat.format(porcentajeNoche) + "%";
		return s;
	}
